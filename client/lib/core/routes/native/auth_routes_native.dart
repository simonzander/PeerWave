...
import '../../../auth/auth_layout_native.dart';
import '../../../auth/otp_web.dart';
import '../../../auth/invitation_entry_page.dart';
import '../../../auth/register_webauthn_page_native.dart';
import '../../../auth/register_profile_page.dart';
import '../../../auth/magic_link_native.dart';
import '../../../app/backupcode_web_native.dart';
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        if (extra is String && extra.isNotEmpty) {
          debugPrint(
            "Rendering MagicLinkWebPageWithServer, clientId: $clientId",
          );
