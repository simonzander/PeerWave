              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildPlatformLimit(
                    context,
                    'Web',
                    FileTransferConfig.maxFileSizeWeb,
                  ),
                  _buildPlatformLimit(
                    context,
                    'Mobile',
                    FileTransferConfig.maxFileSizeMobile,
                  ),
                  _buildPlatformLimit(
                    context,
                    'Desktop',
                    FileTransferConfig.maxFileSizeDesktop,
                  ),
                ],
              ),
            ),
...
Future<bool?> showFileSizeErrorDialog(
  ...
  return showDialog<bool>(
    context: context,
    builder: (context) =>
        FileSizeErrorDialog(fileSize: fileSize, fileName: fileName),
  );
}
