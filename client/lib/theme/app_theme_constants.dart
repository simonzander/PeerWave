...
class AppThemeConstants {
  ...
  static const Color activeChannelBackground = Color.fromRGBO(
    14,
    132,
    129,
    0.08,
  ...
  static const BorderRadius borderRadiusStandard = BorderRadius.all(
  ...
  static const IconData iconSettings =
      Icons.settings_rounded; // Rounded wirkt gefüllter
  ...
  static BorderSide get activeChannelBorderSide =>
      const BorderSide(color: activeChannelBorder, width: borderWidthStandard);
  ...
  static Widget animatedBadge({required Widget child, required bool show}) {
  ...
  static Decoration animatedSelectionDecoration({
    ...
    return BoxDecoration(
      ...
      border: selected
          ? Border(
              left: BorderSide(color: highlightColor, width: borderWidthThick),
            )
          : null,
    );
  }
  ...
  static ListTile styledListTile({
    ...
    return ListTile(
      ...
      onTap: onTap,
      selected: selected,
      shape: RoundedRectangleBorder(borderRadius: borderRadiusStandard),
    );
  }
