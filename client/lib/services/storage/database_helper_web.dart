...
class DatabaseHelperNative {
  static Future<Database> get database async => throw UnimplementedError('Native database not available on web');
  ...
  static String getTableName(String serverHash, String baseTableName) => baseTableName;
